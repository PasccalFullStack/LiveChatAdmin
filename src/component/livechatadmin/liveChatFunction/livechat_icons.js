const livechat_icons = {
    deploy_screen_icon: () => {
        return (
            <svg width="16" height="16" fill="currentColor" className="bi bi-arrows-fullscreen" viewBox="0 0 16 16">
    ...
    retract_screen_icon: () => {
        return (
            <svg width="16" height="16" fill="currentColor" className="bi bi-fullscreen-exit" viewBox="0 0 16 16">
    ...
    message_read: () => {
        return (
            <svg width="20" height="20" fill="currentColor" className="bi bi-envelope-open" viewBox="0 0 16 16">
    ...
    send_message: () => {
        return (
            <svg width="24" height="24" fill="currentColor" className="bi bi-send-plus" viewBox="0 0 16 16">
    ...
    reset_message: () => {
        return (
            <svg width="24" height="24" fill="currentColor" className="bi bi-x-square" viewBox="0 0 16 16">
